...
const RouteWeatherLines: React.FC<RouteWeatherLinesProps> = ({
  ...
  }, [isothermPoints, scales, waypoints]);
  ...
  }, [isotachPoints, scales, waypoints]);
  ...
  }, [dewPointDepressionPoints, scales, waypoints]);
          ...
          return (
            ...
            >
              ...
              <text
                ...
                x={formatNumber(
                  scales.distanceScale(
                    waypoints[Math.floor(firstPoint.x)].distanceNM,
                  ),
                )}
